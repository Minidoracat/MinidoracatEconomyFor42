...
[*] [b]Economy terminals[/b]: machine and catgirl designs can both be registered as an ATM or a trade station; only trade stations provide the market radio. Supported map terminal cabinets can also be registered. Transactions and claims require a nearby terminal by default; remote access rules are server-configurable.
