...
-- newtiledefinitions.tiles CustomName=Terminal). Write commands need the player within
-- TERMINAL_RANGE tiles (Chebyshev, same level) of a registered terminal while the sandbox option
-- RemoteReadOnly is on.
EC.TERMINAL_SPRITES = {
