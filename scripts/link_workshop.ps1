# MinidoracatEconomyFor42 Workshop 符號連結管理
...
# 設定區 - MOD 識別
# ============================================
$MOD_FOLDER = "MinidoracatEconomyFor42"          # MOD/<資料夾名>，也是 Workshop 連結名
$MOD_ID     = "MinidoracatEconomyFor42"              # mod.info 的 id，也是 mods 連結名（通常 = $MOD_FOLDER）
